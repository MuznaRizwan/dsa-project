...
class Button {
public:
	SDL_Rect rect = { 0,0,1,1 }; // SDL_Rect=data type and rect is a variable for drawing rectangle later in the program
	string label; // variable of type string which stores the name of assets
	SDL_Color color = { 0,0,0,0 }; // stores color of rectangle of type SDL_Color
